...
import 'package:yumquickdashboard/feactures/Dashboard/presentation/view/widget/total_orders_item.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  TotalOrdersItem(orderDay: 'May 22', totalOrders: '645'),
                  SizedBox(width: MediaQuery.sizeOf(context).width * 0.027),
                  TotalOrdersItem(orderDay: 'May 21', totalOrders: '472'),
                  Spacer(),
