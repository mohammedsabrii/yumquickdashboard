...
List<StatisticsItemModel> itemMethod(BuildContext context) {
  return [
    StatisticsItemModel(
      ...
      icon: Flexible(
        child: Container(
          ...
          child: Center(
            child: Flexible(child: SvgPicture.asset(AppAssets.kDollarIcon)),
          ),
        ),
      ),
      relaive: '10.54',
    ...
    StatisticsItemModel(
      ...
      icon: Flexible(
        child: Container(
          ...
          child: Center(
            child: Flexible(child: SvgPicture.asset(AppAssets.kCartIcon)),
          ),
        ),
      ),
      relaive: '1,056',
    ...
    StatisticsItemModel(
      ...
      icon: Flexible(
        fit: FlexFit.tight,
        child: SvgPicture.asset(AppAssets.kChartIcon),
      ),
      relaive: '10.27',
      title: 'Unique Visits',
    ),
